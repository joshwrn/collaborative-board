...
export const MOCK_IMAGE_TO_IMAGE_RESPONSE = {
  ...
  prompt: `Convert this sketch to a portrait, using the following description: A tiger is standing in a forest.`,
}

const mock_image_url = `https://fal-cdn.batuhan-941.workers.dev/files/tiger/IExuP-WICqaIesLZAZPur.jpeg`
const mock_prompt = `an island near sea, with seagulls, moon shining over the sea, light house, boats int he background, fish flying over the sea`
